...
function TransferFormICRC2() {
  ...
  async function getCanisterPrincipal(){
    const result = await extc_token_backend.getCanisterPrincipal();
  ...
  */
      ...
      await authClient.login({
          ...
          */ 
          ...
          onSuccess: async () => {  
              ...
              Actor.agentOf(extc_token_backend).replaceIdentity(
  ...
  async function getAccountFromBalance(account) {
    ...
    try {
        if (account != '') {                        
            setFrom(account);
            const result = await extc_token_backend.getBalance(Principal.fromText(account));
  ...
  async function transferTokens() {        
    ...
    try {
        ...
        */
        ...
        const result = await extc_token_backend.transferFrom(Principal.fromText(to), BigInt(amount)); // esta operação consome 10000 tokens (operação de aprovação e transferencia juntas custam 20000)
